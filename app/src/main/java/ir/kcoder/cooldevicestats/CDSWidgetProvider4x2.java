 ...
 */
public class CDSWidgetProvider4x2 extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i=0; i<N; i++) {
            ...
            RemoteViews views4x2 = new RemoteViews(context.getPackageName(), R.layout.cdswidget_clockless);

            setEventHandlers(views4x2, context);

            // Tell the AppWidgetManager to perform an update on the current app widget

            updateImageViews(views4x2, context);
            appWidgetManager.updateAppWidget(appWidgetId, views4x2);
        }
    }
    ...
    public void onReceive(Context context, Intent intent)
    {
            ...
            intent.getAction().equals(ACTION_MANUAL_UPDATE))
        {
            ...
            RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.cdswidget_clockless);
            remoteViews.setInt(R.id.cdsWidget, "setBackgroundColor", prefsManager.getWidgetBg());
            updateImageViews(remoteViews, context);
            ComponentName componentName = new ComponentName(context, CDSWidgetProvider4x2.class);
    ...
    private void setEventHandlers(RemoteViews views, Context context) {
        ...
        Intent updateIntent = new Intent(context, CDSWidgetProvider4x2.class);
